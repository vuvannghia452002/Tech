...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.2]{pictures/Attacking_vectors/malwarecategories.png}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 1.1]{pictures/Attacking_vectors/malwarevulnerablity.png}
